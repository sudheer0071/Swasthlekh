  ...
  return (
    <div className=""> 
     <div className="flex justify-center">
      ...
      <div>
    <div {...getRootProps()} className="flex justify-center h-32 navbar shadow-md shadow-gray-500 p-3 rounded-lg w">
      <input {...getInputProps()} /> 
      ...
      <p className="flex justify-center mt-6 ml-2 font-medium text-lg">Drag and drop PDF files here, <br />or click to select files</p> 
      </div>
    </div> 
    </div>
  );
