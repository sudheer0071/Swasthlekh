...
export function Upload(){
  ...
  return (
    ...
    <div {...getRootProps()} className="flex justify-center w-96 bg-zinc-800 shadow-md shadow-gray-500 p-3 rounded-lg w">
      <input {...getInputProps()} /> 

      <div className="w-12">
      <svg  fill="#FFFFFF" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490.955 490.955">
      ...
      <p >Drag and drop PDF files here, <br />or click to select files</p> 
      </div>
    </div> 
    </div>
  );
