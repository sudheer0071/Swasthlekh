...
export const SideBar = ({user,name}:{name:string,user:string})=>{
  ...
  return  <div id="SIDE BAR" className=" h-screen cursor-pointer border-r-2 navbar font-bold flex-shrink-0">  
...
Requests
  ...
  <div onClick={()=>{setSettings(true);navigate('/')}} className={`border-b-2 border-gray-500 flex p-3 rounded-md pl-10 transition duration-200 ease-in-out transform hover:bg-custom hover:text-black hover:border-gray-700 hover:scale-105 ${settings?'bg-orange-100 translate-x-2 translate-y-1 transition-transform delay-100':''}`}>
<div className=" items-center">
<PanelsTopLeft size={25} />
</div>
<div className=" ml-2 ">
Invoice
  ...
  <div onClick={()=>{setSettings(true);navigate('/')}} className=" border-b-2 border-gray-500 flex p-3 rounded-md pl-10 transition duration-200 ease-in-out transform hover:bg-custom hover:text-black hover:border-gray-700 hover:scale-105">
<div className=" items-center">
<Settings size={25} />
</div>
<div className=" ml-2 ">
